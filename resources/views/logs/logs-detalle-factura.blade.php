                                ...
                                <table id="tabla_sucursal" class="table table-sm table-hover">
                                    <thead style="background-color: #4e73df;">
                                        <tr>
                                            ...
                                            <th class="text-center" style="color:#fff;">ID Detalle Factura</th>
                                            <th class="text-center" style="color:#fff;">Código</th>
                                            <th class="text-center" style="color:#fff;">Descripción</th>
                                            <th class="text-center" style="color:#fff;">Precio Unitario</th>
                                            <th class="text-center" style="color:#fff;">Subtotal</th>
