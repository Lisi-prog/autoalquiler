                                ...
                                <table id="tabla_sucursal" class="table table-sm table-hover">
                                    <thead style="background-color: #4e73df;">
                                        <tr>
                                            ...
                                            <th class="text-center" style="color:#fff;">ID Vehículo x Estado</th>
                                            <th class="text-center" style="color:#fff;">ID Vehículo</th>
                                            <th class="text-center" style="color:#fff;">ID Estado Vehículo</th>
                                            <th class="text-center" style="color:#fff;">Fecha Estado</th>
