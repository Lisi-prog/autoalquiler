                                ...
                                <table id="tabla_sucursal" class="table table-sm table-hover">
                                    <thead style="background-color: #4e73df;">
                                        <tr>
                                            ...
                                            <th class="text-center" style="color:#fff;">ID Mantenimiento</th>
                                            <th class="text-center" style="color:#fff;">Fecha Envío</th>
                                            <th class="text-center" style="color:#fff;">Fecha Devolución</th>
                                            <th class="text-center" style="color:#fff;">ID Vehículo</th>
                                            <th class="text-center" style="color:#fff;">ID Taller</th>
