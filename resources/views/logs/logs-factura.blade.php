                                ...
                                <table id="tabla_sucursal" class="table table-sm table-hover">
                                    <thead style="background-color: #4e73df;">
                                        <tr>
                                            ...
                                            <th class="text-center" style="color:#fff;">ID Factura</th>
                                            <th class="text-center" style="color:#fff;">Fecha Emisión</th>
                                            <th class="text-center" style="color:#fff;">Monto Base</th>
                                            <th class="text-center" style="color:#fff;">Monto Recargo</th>
                                            <th class="text-center" style="color:#fff;">Total</th>
                                            <th class="text-center" style="color:#fff;">ID Alquiler</th>
